...
# def test_create_product(random_product: Dict[str, str]) -> None:
...
# def test_update_product(random_product: Dict[str, str]) -> None:
...
# def test_delete_product(random_product: Dict[str, str]) -> None:
